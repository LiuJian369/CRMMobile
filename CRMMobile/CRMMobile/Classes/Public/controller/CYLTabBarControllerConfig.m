...
@interface CYLBaseNavigationController : BaseNavigationViewController
@end
...
- (NSArray *)viewControllers {
    ...
    MarketViewController *secondViewController = [[MarketViewController alloc] init];
    UIViewController *secondNavigationController = [[CYLBaseNavigationController alloc]
                                                    initWithRootViewController:secondViewController];
    
    CustomerViewController *thirdViewController = [[CustomerViewController alloc] init];
